...
import cvPreview from '../assets/Screenshot 2026-09-15 133706.png'
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_280px] lg:items-center">
          <div className="space-y-4 text-slate-300">
            <p className="leading-8">
              Want to see my experience, skills, and education at a glance? Download the latest CV or preview the image snapshot right here.
            </p>
      ...
      {previewOpen ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/90 p-4">
          <div className="relative w-full max-w-3xl overflow-hidden rounded-[2rem] border border-cyan-400/30 bg-slate-900 shadow-2xl shadow-slate-950/30">
            ...
            <img src={cvPreview} alt="Full CV preview" className="h-auto w-full object-contain" />
